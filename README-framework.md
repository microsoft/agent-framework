...
> � **Looking for the step-by-step tutorial?** See the [Hands-On tutorial](README.md) (now the repository's main README) — build, test (DevUI), publicly host (Foundry), and observe (OpenTelemetry) an agent, step by step.
