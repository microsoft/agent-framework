...
**What gets validated:** All packages marked with `IsReleaseCandidate=true` (future GA
packages) are automatically validated. The baseline version and validation settings are
centralized in `dotnet/nuget/nuget-package.props`.
