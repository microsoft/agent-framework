...
### Subpackage scope
The following is the decision on the subpackage scope, see appendix for alternatives considered and reasoning.
...
## Subpackage scope alternatives and decision
