...
| 75 | `postgres.memory` | PostgreSQL ContextMemory client/provider | `Microsoft.Agents.AI.Postgres.PostgresMemoryClient`; `agent_framework_postgres.PostgresMemoryClient` |
