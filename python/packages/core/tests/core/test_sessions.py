...
def test_filter_approval_controls_follow_up_does_not_resolve_approval_controls() -> None:
    ...
    # Request is resolved by the matching response: removed
    # Response is kept because no terminal result exists: preserved
    # Follow-up has no effect on either decision
