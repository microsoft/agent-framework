...
_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "FoundryChatClient": ("agent_framework_azure_ai", "agent-framework-azure-ai"),
    "FoundryMemoryProvider": ("agent_framework_azure_ai", "agent-framework-azure-ai"),
    "RawFoundryChatClient": ("agent_framework_azure_ai", "agent-framework-azure-ai"),
    ...
    "FoundryAgent": ("agent_framework_azure_ai", "agent-framework-azure-ai"),
    "RawFoundryAgentChatClient": ("agent_framework_azure_ai", "agent-framework-azure-ai"),
    "RawFoundryAgent": ("agent_framework_azure_ai", "agent-framework-azure-ai"),
