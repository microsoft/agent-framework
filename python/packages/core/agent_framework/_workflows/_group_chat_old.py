...
from ._base_group_chat_orchestrator import BaseGroupChatOrchestrator, GroupChatRequestMessage
...
class GroupChatOrchestratorExecutor(BaseGroupChatOrchestrator):
    ...
    async def _complete_on_termination(
        self,
        ctx: WorkflowContext[AgentExecutorRequest | GroupChatRequestMessage, list[ChatMessage]],
    ) -> bool:
    ...
    **Important Constraints:**
        ...
        *,
        ...
        Args:
            ...
            display_name: Optional name for manager messages in conversation history.
                If not provided, uses manager.display_name for AgentProtocol or manager.id for Executor.
    ...
    def participants(self, participants: Sequence[AgentProtocol | Executor]) -> "GroupChatBuilder":
        ...
        for participant in participants:
            ...
            self._participants[identifier] = participant
