...
- Once an invocation limit disables tools, provider-emitted calls or approval requests are removed from both
  streaming and final output; metadata-only stream updates remain visible.
