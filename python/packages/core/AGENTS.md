...
- Compaction pairs reused `call_id` values by ordered unambiguous occurrence. A result links only when exactly one
  preceding declaration remains unmatched; genuinely ambiguous duplicate declarations stay separate.
