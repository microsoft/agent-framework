...
class WorkflowFactory:
    ...
    _agents: dict[str, AgentLike | AgentExecutor]

    def __init__(
        self,
        *,
        agent_factory: AgentFactory | None = None,
        agents: Mapping[str, AgentLike | AgentExecutor] | None = None,
        ...
        self._agents: dict[str, AgentLike | AgentExecutor] = dict(agents) if agents else {}
    ...
    def create_workflow_from_definition(
        ...
        agents: dict[str, AgentLike | AgentExecutor] = dict(self._agents)
    ...
    def _create_workflow(
        ...
        agents: dict[str, AgentLike | AgentExecutor],
    ) -> Workflow:
    ...
    def register_agent(self, name: str, agent: AgentLike | AgentExecutor) -> "WorkflowFactory":
