...
For serialization constants, use the Fields, ContentTypes, and EntryTypes classes
...
class Fields:
    ...
    # Legacy/internal field names (for backward compatibility)
    JSON_TYPE_LEGACY: Final[str] = "json_type"  # Legacy field name for entry type
    TYPE_INTERNAL: Final[str] = "type"  # Internal key in content dicts
...
class Defaults:
    """Default values and fallback constants."""

    SCHEMA_VERSION_FALLBACK: Final[str] = "1.0.0"
    ENTRY_TYPE_FALLBACK: Final[str] = "entry"


# Note: Entry types (request/response) are defined as DurableAgentStateEntryJsonType enum
# in _durable_agent_state.py for better type safety and exhaustiveness checking.
