...
from agent_framework import AgentLike, get_logger
...
class AgentMetadata:
    ...
    Attributes:
        agent: The agent instance implementing AgentLike
...
class AgentFunctionApp(DFAppBase):
    ...
    Attributes:
        agents: Dictionary of agent name to AgentLike instance
    ...
    @property
    def agents(self) -> dict[str, AgentLike]:
        """Returns dict of agent names to agent instances.

        Returns:
            Dictionary mapping agent names to their AgentLike instances.
        """
    ...
    def add_agent(
        ...
        Args:
            agent: The Microsoft Agent Framework agent instance (must implement AgentLike)
