...
def test_function_approval_response_with_mcp_tool_call() -> None:
    ...
    # so we must construct a hosted function call explicitly for _is_hosted_tool_approval
...
def test_prepare_content_drops_local_approval_request() -> None:
    ...
    # Local requests return empty dict, which upstream filters out via `if prepared:`
    assert result == {}
...
def test_prepare_messages_stores_suppresses_request_but_keeps_response() -> None:
    ...
    # Simulate service-side storage being active
