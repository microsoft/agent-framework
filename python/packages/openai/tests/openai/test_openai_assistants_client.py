...
async def test_get_response() -> None:
    ...
    async with OpenAIAssistantsClient(model=INTEGRATION_TEST_MODEL) as openai_assistants_client:
...
async def test_with_existing_assistant() -> None:
    ...
    async with OpenAIAssistantsClient(model=INTEGRATION_TEST_MODEL) as temp_client:
        ...
        async with OpenAIAssistantsClient(
            model=INTEGRATION_TEST_MODEL, assistant_id=assistant_id
...
async def test_openai_assistants_agent_basic_run():
    ...
    async with Agent(
        client=OpenAIAssistantsClient(model=INTEGRATION_TEST_MODEL),
    ) as agent:
        # Run a simple query
