...
from ._events import WorkflowCompletedEvent, WorkflowEvent, WorkflowEventSource
                ...
                if not tasks:
                    ...
                    try:  # Local import to avoid circular dependencies at module import time.
                        ...
                        if isinstance(message.data, AgentExecutorResponse):
                            ...
                            await self._ctx.add_event(
                                WorkflowCompletedEvent(final_text, origin=WorkflowEventSource.SYSTEM)
                            )
