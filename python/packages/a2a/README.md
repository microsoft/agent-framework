...
HTTP clients created by `A2AAgent` do not persist response cookies. This prevents
...
If the remote service requires cookie-based sessions, explicitly supply an
