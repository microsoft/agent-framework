...
See the [Azure AI Search context provider examples](https://github.com/microsoft/agent-framework/tree/main/python/samples/02-agents/providers/azure_ai/) which demonstrate:
