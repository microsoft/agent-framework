...
class TestDurableAIAgentLikeCompliance:
    """Test that DurableAIAgent implements AgentLike correctly."""

    def test_agent_implements_protocol(self, test_agent: DurableAIAgent[Any]) -> None:
        """Verify DurableAIAgent implements AgentLike."""
        assert isinstance(test_agent, AgentLike)

    def test_agent_has_required_properties(self, test_agent: DurableAIAgent[Any]) -> None:
        """Verify DurableAIAgent has all required AgentLike properties."""
