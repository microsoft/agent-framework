...
#     openai_response_client = OpenAIResponsesClient(ai_model_id="gpt-4.1-mini")

#     assert isinstance(openai_response_client, ChatClient)
...
#     response = await openai_response_client.get_response(messages=messages)
