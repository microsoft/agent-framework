...
from ._shared import OpenAIBase, OpenAIConfigBase, OpenAISettings, prepare_function_call_results
...
@use_telemetry
@use_tool_calling
class OpenAIResponsesClient(OpenAIConfigBase, OpenAIBaseResponsesClient):
