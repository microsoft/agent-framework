...
from devui.discovery import DirectoryScanner
...
class MockAgent(AgentProtocol):
    ...
    async def run_stream(self, messages: Any = None, *, thread: Any = None, **kwargs: Any) -> AsyncIterable[AgentRunResponseUpdate]:
