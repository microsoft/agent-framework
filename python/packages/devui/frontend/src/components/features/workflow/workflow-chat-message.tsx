...
import { Copy, User, RotateCw } from "lucide-react";
  ...
  return (
    <Message from="assistant">
      <MessageAvatar src="" name={initials}>
        <div
          className="flex items-center justify-center w-full h-full text-white font-semibold text-xs rounded-full bg-(--avatar-bg)"
