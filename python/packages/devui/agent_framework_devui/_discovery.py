...
class EntityDiscovery:
    ...
    async def fetch_remote_entity(self, url: str, metadata: dict | None = None) -> tuple[EntityInfo | None, str | None]:
        ...
        """
        try:
            # 1. Normalize URL (convert GitHub blob -> raw, etc.)
            normalized_url = self._normalize_url(url)
            logger.info(f"Normalized URL: {normalized_url}")

            # 2. Fetch content with validation
            ...
            # 4. Create temporary module and extract entity
            ...
            # 5. Create EntityInfo with remote source
            ...
            # 6. Update metadata for remote source
            ...
            # 7. Register entity (ID already generated by create_entity_info_from_object)
