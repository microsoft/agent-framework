...
try:
    ...
    from agent_framework._types import DataContent, Role, TextContent, UriContent
...
def frontend_messages_to_chat_messages(frontend_messages: Union[str, List[Dict[str, Any]]]) -> Union[str, List[Any]]:
...
def validate_frontend_message(
    msg_dict: Dict[str, Any], max_content_size: int = 50 * 1024 * 1024
