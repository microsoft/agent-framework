...
def _create_task_steps_agent(chat_client: SupportsChatGetResponse[Any]) -> AgentFrameworkAgent:
...
def task_steps_agent_wrapped(chat_client: SupportsChatGetResponse[Any]) -> TaskStepsAgentWithExecution:
