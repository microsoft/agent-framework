...
See the [Mem0 basic example](https://github.com/microsoft/agent-framework/tree/main/python/samples/02-agents/context_providers/mem0/mem0_basic.py) which demonstrates:
