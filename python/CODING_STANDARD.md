...
│   ├── FunctionCallInvalidatedException          # Provider invalidated emitted local function calls
...
| Chat provider invalidates local function calls already present in response content | `FunctionCallInvalidatedException` |
