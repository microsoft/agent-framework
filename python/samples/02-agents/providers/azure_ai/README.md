...
## Memory capabilities note

For memory retrieval/update workflows, prefer `FoundryMemoryProvider` instead of tool-based memory search helpers.
See [`../../context_providers/azure_ai_foundry_memory.py`](../../context_providers/azure_ai_foundry_memory.py).
