...
| [`foundry_agent_tracing.py`](../../observability/foundry_agent_tracing.py) | Existing-agent tracing with helper or application-managed exporters and per-agent project attribution |
