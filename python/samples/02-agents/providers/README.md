...
| [`azure/`](azure/) | Azure AI Foundry samples using `FoundryChatClient`, `FoundryAgent`, and `FoundryAgentClient` for Responses API, pre-configured agents, and hosted tools. |
