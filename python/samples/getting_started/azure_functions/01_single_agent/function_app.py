...
- AzureOpenAIAssistantsClient to call the Azure OpenAI chat deployment.
...
from agent_framework.azure import AgentFunctionApp, AzureOpenAIAssistantsClient
from azure.identity import AzureCliCredential
# 1. Instantiate the agent with the chosen deployment and instructions.
def _create_agent() -> Any:
    """Create the Joker agent."""

    return AzureOpenAIAssistantsClient(credential=AzureCliCredential()).create_agent(
        name="Joker",
