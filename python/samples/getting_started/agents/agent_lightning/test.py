...
async def main(assistant_model: str, assistant_sliding_window: int, user_model: str, judge_model: str):
    ...
    _logger.info(f"<cyan>All tasks accuracy:</cyan> {all_accuracy:.2f} ({len(all_results)}/{len(tasks)})")
