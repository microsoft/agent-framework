...
dotenv run python test.py --assistant Qwen2.5-3B-Instruct --user gpt-4.1 --assistant-sliding-window 4000
dotenv run python test.py --assistant gpt-4o --user gpt-4.1 --assistant-sliding-window 28000
