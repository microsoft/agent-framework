...
from agent_framework import AgentLike, AgentResponse, AgentThread, ChatMessage, HostedMCPTool
...
async def handle_approvals_without_thread(query: str, agent: "AgentLike") -> AgentResponse:
...
async def handle_approvals_with_thread(query: str, agent: "AgentLike", thread: "AgentThread") -> AgentResponse:
