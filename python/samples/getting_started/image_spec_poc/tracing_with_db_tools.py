...
# Scenario where the DB has a bunch of base64 images stored and the user provides text_id to fetch the image.
...
from database_logic_for_storing_images import create_and_store_base64_encoded_images
