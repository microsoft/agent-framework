...
def create_workflow(checkpoint_storage: FileCheckpointStorage) -> Workflow:
    ...
    workflow_builder = (
        ...
        .register(lambda: ReviewGateway(id="review_gateway", writer_id="writer"), name="review_gateway")
        .register(lambda: BriefPreparer(id="prepare_brief", agent_id="writer"), name="prepare_brief")
