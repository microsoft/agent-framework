...
async def main() -> None:
    ...
    workflow = (
        ...
        .register(lambda: to_email_assistant_request, name="to_email_assistant_request")
        .register(lambda: handle_email_response, name="send_email")
        .register(lambda: handle_spam_classifier_response, name="handle_spam")
