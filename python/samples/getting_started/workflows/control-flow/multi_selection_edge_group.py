...
async def main() -> None:
    ...
    workflow_builder = (
        ...
        .register(lambda: store_email, name="store_email")
        .register(lambda: to_analysis_result, name="to_analysis_result")
        .register(lambda: submit_to_email_assistant, name="submit_to_email_assistant")
        .register(lambda: finalize_and_send, name="finalize_and_send")
        .register(lambda: summarize_email, name="summarize_email")
        .register(lambda: merge_summary, name="merge_summary")
        .register(lambda: handle_spam, name="handle_spam")
        .register(lambda: handle_uncertain, name="handle_uncertain")
        .register(lambda: database_access, name="database_access")
    )
