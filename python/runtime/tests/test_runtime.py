...
class TestInProcessActorClient:
    ...
    async def test_send_request_success(self, runtime_and_client):
        ...
        # Send echo request
        response_handle = await client.send_request(actor_id=actor_id, method="echo", params={"text": "hello world"})
    ...
    async def test_send_request_failure(self, runtime_and_client):
        ...
        response_handle = await client.send_request(actor_id=actor_id, method="unknown_method", params={})
    ...
    async def test_concurrent_requests(self, runtime_and_client):
        ...
        for i in range(5):
            ...
            task = client.send_request(actor_id=actor_id, method="echo", params={"text": f"message-{i}"})
            tasks.append(task)
    ...
    async def test_watch_updates(self, runtime_and_client):
        ...
        # Send request
        response_handle = await client.send_request(actor_id=actor_id, method="echo", params={"text": "streaming test"})
