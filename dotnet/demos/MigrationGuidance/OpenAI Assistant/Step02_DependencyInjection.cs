...
internal sealed class OpenAIAssistantDependencyInjection
{
    private static async Task Main(string[] args)
    {
        Console.ForegroundColor = ConsoleColor.Gray;

        var apiKey = new ConfigurationBuilder().AddUserSecrets<OpenAIAssistantDependencyInjection>().Build()["OpenAI:ApiKey"]!;
        var modelId = "gpt-4o";
