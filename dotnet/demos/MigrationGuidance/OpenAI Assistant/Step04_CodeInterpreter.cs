...
internal sealed class OpenAIAssistantCodeInterpreter
{
    private static async Task Main(string[] args)
    {
        Console.ForegroundColor = ConsoleColor.Gray;

        var apiKey = new ConfigurationBuilder().AddUserSecrets<OpenAIAssistantCodeInterpreter>().Build()["OpenAI:ApiKey"]!;
        var modelId = "gpt-4o";
