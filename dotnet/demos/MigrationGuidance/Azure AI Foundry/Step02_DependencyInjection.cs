...
internal sealed class AzureAIDependencyInjection
{
    private static async Task Main(string[] args)
    {
        Console.ForegroundColor = ConsoleColor.Gray;

        var azureEndpoint = new ConfigurationBuilder().AddUserSecrets<AzureAIDependencyInjection>().Build()["AzureAI:Endpoint"]!;
        var modelId = "gpt-4.1";
