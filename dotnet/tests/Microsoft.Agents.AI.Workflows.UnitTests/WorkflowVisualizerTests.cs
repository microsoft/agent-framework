...
public class WorkflowVisualizerTests
{
    ...
    public void Test_WorkflowViz_FanIn_EdgeGroup()
    {
        ...
        var workflow = new WorkflowBuilder("start")
            .AddFanOutEdge(start, null, s1, s2)
            .AddFanInEdge(t, null, s1, s2)  // AddFanInEdge(target, sources)
            .Build();
    ...
    */
    ...
    public void Test_WorkflowViz_FanOut_Edges()
    {
        ...
        var workflow = new WorkflowBuilder("start")
            .AddFanOutEdge(start, null, target1, target2, target3)
            .Build();
    ...
    public void Test_WorkflowViz_Mixed_EdgeTypes()
    {
        ...
        var workflow = new WorkflowBuilder("start")
            ...
            .AddFanOutEdge(a, null, b, c) // Fan-out
            .AddFanInEdge(end, null, b, c) // Fan-in - AddFanInEdge(target, sources)
            .Build();
    ...
    public void Test_WorkflowViz_Mermaid_Mixed_EdgeTypes()
    {
        ...
        var workflow = new WorkflowBuilder("start")
            .AddEdge<string>(start, a, Condition) // Conditional edge
            .AddFanOutEdge(a, null, b, c) // Fan-out
            .AddFanInEdge(end, null, b, c) // Fan-in
            .Build();
