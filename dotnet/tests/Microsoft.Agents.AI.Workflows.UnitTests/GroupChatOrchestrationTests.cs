...
public class GroupChatOrchestrationTests
{
    ...
    public async Task GroupChat_AsAgent_PropagatesRunOptionsToEveryParticipantAsync()
    {
        ...
        // Assert
        Assert.NotEmpty(firstAgent.RecordedRunOptions);
        Assert.All(firstAgent.RecordedRunOptions, options => Assert.Same(runOptions, options));
        Assert.NotEmpty(secondAgent.RecordedRunOptions);
        Assert.All(secondAgent.RecordedRunOptions, options => Assert.Same(runOptions, options));
    }
