...
internal static class TextMessageStreamingExtensions
{
    ...
    public static IEnumerable<AgentResponseUpdate> ToAgentStream(this string message, DateTimeOffset? createdAt = null, string? messageId = null, string? responseId = null, string? agentId = null, string? authorName = null)
    {
