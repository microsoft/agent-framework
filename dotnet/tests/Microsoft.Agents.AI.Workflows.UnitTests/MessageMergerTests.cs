...
public class MessageMergerTests
{
    ...
    public void Test_MessageMerger_AssemblesMessage()
    {
        ...
        foreach (AgentResponseUpdate update in "Hello Agent Framework Workflows!".ToAgentStream(authorName: TestAuthorName1, agentId: TestAgentId1, messageId: messageId, createdAt: creationTime, responseId: responseId))
        {
