...
{
    [Fact]
    public void ConstructorWithoutParametersShouldCreateNewHostApplicationBuilder()
    {
        // Act
    ...
    [Fact]
    public void ConstructorWithBaseBuilderShouldUseProvidedBuilder()
    {
        // Arrange
    ...
    [Fact]
    public void ServicesShouldReturnBuilderServices()
    {
        // Arrange
        AgentsAppBuilder builder = new();
    ...
    [Fact]
    public void ConfigurationShouldReturnBuilderConfiguration()
    {
        // Arrange
        AgentsAppBuilder builder = new();
    ...
    [Fact]
    public async Task UseRuntimeShouldRegisterRuntimeInServicesAsync()
    {
        // Arrange
        AgentsAppBuilder builder = new();
    ...
    [Fact]
    public void AddAgentsFromAssembliesWithoutParametersShouldScanCurrentDomain()
    {
        // Arrange
        AgentsAppBuilder builder = new();
    ...
    [Fact]
    public void AddAgentsFromAssembliesWithAssembliesShouldRegisterAgentsFromProvidedAssemblies()
    {
        // Arrange
        AgentsAppBuilder builder = new();
    ...
    [Fact]
    public void AddAgentShouldRegisterAgentType()
    {
        // Arrange
        AgentsAppBuilder builder = new();
    ...
    [Fact]
    public async Task BuildAsyncShouldReturnAgentsAppWithRegisteredAgentsAsync()
    {
        // Arrange
        AgentsAppBuilder builder = new();
        await using InProcessRuntime runtime = new();
