...
{
    [Fact]
    public async Task TestSendMessageReturnsValueAsync()
    {
    ...
    [Fact]
    public async Task TestSendMessageCancellationAsync()
    {
        MessagingTestFixture fixture = new();
    ...
    [Fact]
    public async Task TestSendMessageErrorAsync()
    {
        MessagingTestFixture fixture = new();
    ...
    [Fact]
    public async Task TestSendMessageFromSendMessageHandlerAsync()
    {
