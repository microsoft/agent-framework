...
{
    [Fact]
    public async Task TestPublishMessageSuccessAsync()
    {
    ...
    [Fact]
    public async Task TestPublishMessageSingleFailureAsync()
    {
        MessagingTestFixture fixture = new();
    ...
    [Fact]
    public async Task TestPublishMessageMultipleFailuresAsync()
    {
        MessagingTestFixture fixture = new();
    ...
    [Fact]
    public async Task TestPublishMessageMixedSuccessFailureAsync()
    {
        MessagingTestFixture fixture = new();
    ...
    [Fact]
    public async Task TestPublishMessageRecurrentPublishSucceedsAsync()
    {
        MessagingTestFixture fixture = new();
