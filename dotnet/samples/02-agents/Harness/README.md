...
| [Harness_Step04_CodingAgent](./Harness_Step04_CodingAgent/README.md) | Using FileSystemToolProvider for a sandboxed coding agent with line-precise edits, ripgrep search, gitignore-aware discovery, and approval-gated mutations |
