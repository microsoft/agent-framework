...
AIAgent agent = new AzureOpenAIClient(
    ...
    new DefaultAzureCredential())
     .GetResponsesClient()
     .AsAIAgent(defaultModelId: deploymentName, instructions: "You are good at telling jokes.", name: "Joker");
...
AIAgent agentStoreFalse = new AzureOpenAIClient(
    ...
    new DefaultAzureCredential())
     .GetResponsesClient()
     .AsIChatClientWithStoredOutputDisabled(defaultModelId: deploymentName)
