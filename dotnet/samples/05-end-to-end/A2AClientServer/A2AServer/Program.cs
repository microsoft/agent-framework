...
// IMPORTANT: In production, register a StoreIsolationKeyProvider to isolate sessions and tasks by authenticated caller.
...
// builder.Services.UseClaimsBasedStoreIsolation(new() { ClaimType = ClaimTypes.NameIdentifier });
