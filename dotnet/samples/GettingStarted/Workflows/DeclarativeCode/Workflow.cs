...
public static class WorkflowProvider
{
    ...
    /// <summary>
    /// // %%% BEGIN ACTION SCOPE FOR: "my_workflow"
    /// </summary>
    /// <remarks>
    /// This action does nothing but exists so to it may be used as a target for an edge from other actions.
    /// </remarks>
    internal sealed class MyWorkflowExecutor(FormulaSession session) : ActionExecutor(id: "my_workflow", session)
    {
        /// <inheritdoc />
        ...
        where TInput : notnull
    {
        ...
        MyWorkflowExecutor myWorkflow = new(myWorkflowRoot.Session);
