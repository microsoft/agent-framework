...
| [Mixed Workflow with Agents and Executors](./_Foundational/07_MixedWorkflowWithAgentsAndExecutors) | Shows how to mix agents and executors with adapter pattern for type conversion and protocol handling |
