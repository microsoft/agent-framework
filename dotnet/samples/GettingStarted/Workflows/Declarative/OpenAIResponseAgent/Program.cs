...
internal sealed class Program
{
    ...
    private Workflow CreateWorkflow()
    {
        ...
        OpenAIClient client = new(this.ApiKey);
        OpenAIResponseAgentProvider agentProvider = new(client)
        {
    ...
    private Program(string workflowFile, string? workflowInput)
    {
        ...
        this.ApiKey = this.Configuration[Application.Settings.OpenAIApiKey] ?? throw new InvalidOperationException($"Undefined configuration setting: {Application.Settings.FoundryEndpoint}");
