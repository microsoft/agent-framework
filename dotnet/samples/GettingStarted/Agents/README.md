...
|[Deep research with Azure AI Foundry Agents](./Agent_Step18_DeepResearch/)|This sample demonstrates how to use the Deep Research Tool with Azure AI Foundry Agents for comprehensive research using the o3-deep-research reasoning model|
