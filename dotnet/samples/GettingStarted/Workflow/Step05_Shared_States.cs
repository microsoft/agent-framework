...
/// <summary>
/// This sample demonstrates shared state management to improve upon the previous edge condition example.
///
/// In Step04_Edge_Condition, email content was passed around as part of detection results, which
/// created data duplication and potential inconsistencies. This sample solves that problem by
/// introducing shared states that multiple executors can access.
///
/// Key improvements:
/// - Email content is stored once in shared state, eliminating duplication
/// - Executors access shared data rather than passing it through message chains
/// - Better data consistency and reduced complexity in message handling
///
/// The workflow logic remains the same (spam detection → appropriate handling), but the
/// implementation is cleaner and more maintainable using shared state patterns.
/// </summary>
public class Step05_Shared_States(ITestOutputHelper output) : WorkflowSample(output)
{
