...
/// <summary>
/// Options for configuring <see cref="ClaimsIdentityStoreIsolationKeyProvider"/>.
/// </summary>
public class ClaimsIdentityStoreIsolationKeyProviderOptions
{
    /// <summary>
    /// Gets or sets the claim type to extract from the user's identity for store isolation.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// would receive the same store-isolation key and could read or overwrite one another's
