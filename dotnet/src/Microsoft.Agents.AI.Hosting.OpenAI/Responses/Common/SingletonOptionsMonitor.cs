...
internal class SingletonOptionsMonitor<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)] TOptions>(TOptions options) : IOptionsMonitor<TOptions>, IOptionsSnapshot<TOptions>
