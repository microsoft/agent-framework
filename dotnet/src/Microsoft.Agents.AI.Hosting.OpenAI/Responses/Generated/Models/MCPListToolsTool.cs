...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    internal partial class MCPListToolsTool
    {
        /// <summary>
        ...
        internal MCPListToolsTool(string name, string description, BinaryData inputSchema, BinaryData annotations, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
