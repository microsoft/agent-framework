...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    ///
    /// </summary>
    internal partial class ComputerToolCallItemResource : ItemResource
    {
        ...
        internal ComputerToolCallItemResource(string id, ComputerToolCallItemResourceStatus status, string callId, ComputerAction action, IEnumerable<ComputerToolCallSafetyCheck> pendingSafetyChecks) : base(id)
        {
        ...
        /// </param>
        /// <param name="pendingSafetyChecks"> The pending safety checks for the computer call. </param>
        internal ComputerToolCallItemResource(ItemType type, string id, IDictionary<string, BinaryData> serializedAdditionalRawData, ComputerToolCallItemResourceStatus status, string callId, ComputerAction action, IReadOnlyList<ComputerToolCallSafetyCheck> pendingSafetyChecks) : base(type, id, serializedAdditionalRawData)
        {
            Status = status;
            CallId = callId;
            Action = action;
        ...
        internal ComputerToolCallItemResource()
        {
        }
