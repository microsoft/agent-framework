...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    internal partial class ResponseContentPartAddedEvent : ResponseStreamEvent
    {
        ...
        internal ResponseContentPartAddedEvent(int sequenceNumber, string itemId, int outputIndex, int contentIndex, ItemContent part) : base(sequenceNumber)
        {
        ...
        /// The available derived classes include <see cref="ItemContentInputAudio"/>, <see cref="ItemContentInputFile"/>, <see cref="ItemContentInputImage"/>, <see cref="ItemContentInputText"/>, <see cref="ItemContentOutputAudio"/>, <see cref="ItemContentOutputText"/> and <see cref="ItemContentRefusal"/>.
        /// </param>
        internal ResponseContentPartAddedEvent(ResponseStreamEventType type, int sequenceNumber, IDictionary<string, BinaryData> serializedAdditionalRawData, string itemId, int outputIndex, int contentIndex, ItemContent part) : base(type, sequenceNumber, serializedAdditionalRawData)
        {
            ItemId = itemId;
            OutputIndex = outputIndex;
            ContentIndex = contentIndex;
