...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    internal partial class RankingOptions
    {
        /// <summary>
        ...
        internal RankingOptions(RankingOptionsRanker? ranker, float? scoreThreshold, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Ranker = ranker;
