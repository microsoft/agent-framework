...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    internal partial class ResponseRefusalDoneEvent : ResponseStreamEvent
    {
        ...
        internal ResponseRefusalDoneEvent(int sequenceNumber, string itemId, int outputIndex, int contentIndex, string refusal) : base(sequenceNumber)
        {
        ...
        /// <param name="contentIndex"> The index of the content part that the refusal text is finalized. </param>
        /// <param name="refusal"> The refusal text that is finalized. </param>
        internal ResponseRefusalDoneEvent(ResponseStreamEventType type, int sequenceNumber, IDictionary<string, BinaryData> serializedAdditionalRawData, string itemId, int outputIndex, int contentIndex, string refusal) : base(type, sequenceNumber, serializedAdditionalRawData)
        {
            ItemId = itemId;
            OutputIndex = outputIndex;
            ContentIndex = contentIndex;
