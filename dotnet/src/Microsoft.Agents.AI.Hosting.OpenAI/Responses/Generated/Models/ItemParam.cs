...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    /// </summary>
    internal abstract partial class ItemParam
    {
        /// <summary>
        ...
        internal ItemParam(ItemType type, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
        ...
        /// Manually added
        /// </summary>
        public IDictionary<string, BinaryData> SerializedAdditionalRawData => _serializedAdditionalRawData ?? new Dictionary<string, BinaryData>();
    }
}
