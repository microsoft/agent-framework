...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    internal partial class AnnotationUrlCitation : Annotation
    {
        ...
        /// <param name="endIndex"> The index of the last character of the URL citation in the message. </param>
        /// <param name="title"> The title of the web resource. </param>
        internal AnnotationUrlCitation(AnnotationType type, IDictionary<string, BinaryData> serializedAdditionalRawData, Uri url, int startIndex, int endIndex, string title) : base(type, serializedAdditionalRawData)
        {
            Url = url;
            StartIndex = startIndex;
            EndIndex = endIndex;
        ...
        internal AnnotationUrlCitation()
        {
        }
