...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    internal partial class ResponseCodeInterpreterCallCodeDoneEvent : ResponseStreamEvent
    {
        ...
        internal ResponseCodeInterpreterCallCodeDoneEvent(int sequenceNumber, int outputIndex, string itemId, string code) : base(sequenceNumber)
        {
        ...
        /// <param name="itemId"> The unique identifier of the code interpreter tool call item. </param>
        /// <param name="code"> The final code snippet output by the code interpreter. </param>
        internal ResponseCodeInterpreterCallCodeDoneEvent(ResponseStreamEventType type, int sequenceNumber, IDictionary<string, BinaryData> serializedAdditionalRawData, int outputIndex, string itemId, string code) : base(type, sequenceNumber, serializedAdditionalRawData)
        {
            OutputIndex = outputIndex;
            ItemId = itemId;
            Code = code;
