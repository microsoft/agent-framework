...
{
    internal partial class UnknownAnnotation : IJsonModel<Annotation>
    {
        ...
        internal static UnknownAnnotation DeserializeUnknownAnnotation(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        internal static new UnknownAnnotation FromResponse(PipelineResponse response)
        {
        ...
        {
            return BinaryContent.Create<Annotation>(this, ModelSerializationExtensions.WireOptions);
        }
    }
}
