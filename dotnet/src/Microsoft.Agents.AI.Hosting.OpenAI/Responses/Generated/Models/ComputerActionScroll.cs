...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    internal partial class ComputerActionScroll : ComputerAction
    {
        ...
        /// <param name="scrollX"> The horizontal scroll distance. </param>
        /// <param name="scrollY"> The vertical scroll distance. </param>
        internal ComputerActionScroll(ComputerActionType type, IDictionary<string, BinaryData> serializedAdditionalRawData, int x, int y, int scrollX, int scrollY) : base(type, serializedAdditionalRawData)
        {
            X = x;
            Y = y;
            ScrollX = scrollX;
