...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    internal partial class ResponseReasoningSummaryPartAddedEvent : ResponseStreamEvent
    {
        ...
        internal ResponseReasoningSummaryPartAddedEvent(int sequenceNumber, string itemId, int outputIndex, int summaryIndex, ReasoningItemSummaryPart part) : base(sequenceNumber)
        {
        ...
        /// The available derived classes include <see cref="ReasoningItemSummaryTextPart"/>.
        /// </param>
        internal ResponseReasoningSummaryPartAddedEvent(ResponseStreamEventType type, int sequenceNumber, IDictionary<string, BinaryData> serializedAdditionalRawData, string itemId, int outputIndex, int summaryIndex, ReasoningItemSummaryPart part) : base(type, sequenceNumber, serializedAdditionalRawData)
        {
            ItemId = itemId;
            OutputIndex = outputIndex;
            SummaryIndex = summaryIndex;
