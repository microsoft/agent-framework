...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    internal partial class ResponseReasoningSummaryTextDoneEvent : ResponseStreamEvent
    {
        ...
        internal ResponseReasoningSummaryTextDoneEvent(int sequenceNumber, string itemId, int outputIndex, int summaryIndex, string text) : base(sequenceNumber)
        {
        ...
        /// <param name="summaryIndex"> The index of the summary part within the reasoning summary. </param>
        /// <param name="text"> The full text of the completed reasoning summary. </param>
        internal ResponseReasoningSummaryTextDoneEvent(ResponseStreamEventType type, int sequenceNumber, IDictionary<string, BinaryData> serializedAdditionalRawData, string itemId, int outputIndex, int summaryIndex, string text) : base(type, sequenceNumber, serializedAdditionalRawData)
        {
            ItemId = itemId;
            OutputIndex = outputIndex;
            SummaryIndex = summaryIndex;
        ...
        internal ResponseReasoningSummaryTextDoneEvent()
        {
        }
