...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    internal partial class ResponseRefusalDeltaEvent : ResponseStreamEvent
    {
        ...
        internal ResponseRefusalDeltaEvent(int sequenceNumber, string itemId, int outputIndex, int contentIndex, string delta) : base(sequenceNumber)
        {
        ...
        /// <param name="contentIndex"> The index of the content part that the refusal text is added to. </param>
        /// <param name="delta"> The refusal text that is added. </param>
        internal ResponseRefusalDeltaEvent(ResponseStreamEventType type, int sequenceNumber, IDictionary<string, BinaryData> serializedAdditionalRawData, string itemId, int outputIndex, int contentIndex, string delta) : base(type, sequenceNumber, serializedAdditionalRawData)
        {
            ItemId = itemId;
            OutputIndex = outputIndex;
            ContentIndex = contentIndex;
