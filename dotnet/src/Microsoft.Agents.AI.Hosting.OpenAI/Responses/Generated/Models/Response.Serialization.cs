...
{
    internal partial class Response : IJsonModel<Response>
    {
        ...
        internal static Response DeserializeResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("error"u8))
                {
                    ...
                    error = ResponseError.DeserializeResponseError(property.Value, options);
                    continue;
                }
        ...
        internal static Response FromResponse(PipelineResponse response)
        {
