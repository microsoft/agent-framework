...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    internal partial class ResponseReasoningSummaryTextDeltaEvent : ResponseStreamEvent
    {
        ...
        internal ResponseReasoningSummaryTextDeltaEvent(int sequenceNumber, string itemId, int outputIndex, int summaryIndex, string delta) : base(sequenceNumber)
        {
        ...
        /// <param name="summaryIndex"> The index of the summary part within the reasoning summary. </param>
        /// <param name="delta"> The text delta that was added to the summary. </param>
        internal ResponseReasoningSummaryTextDeltaEvent(ResponseStreamEventType type, int sequenceNumber, IDictionary<string, BinaryData> serializedAdditionalRawData, string itemId, int outputIndex, int summaryIndex, string delta) : base(type, sequenceNumber, serializedAdditionalRawData)
        {
            ItemId = itemId;
            OutputIndex = outputIndex;
            SummaryIndex = summaryIndex;
