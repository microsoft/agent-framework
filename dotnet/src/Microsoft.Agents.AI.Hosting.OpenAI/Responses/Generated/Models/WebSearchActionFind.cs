...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    internal partial class WebSearchActionFind : WebSearchAction
    {
        ...
        /// <param name="url"> The URL of the page searched for the pattern. </param>
        /// <param name="pattern"> The pattern or text to search for within the page. </param>
        internal WebSearchActionFind(WebSearchActionType type, IDictionary<string, BinaryData> serializedAdditionalRawData, Uri url, string pattern) : base(type, serializedAdditionalRawData)
        {
            Url = url;
            Pattern = pattern;
        }
