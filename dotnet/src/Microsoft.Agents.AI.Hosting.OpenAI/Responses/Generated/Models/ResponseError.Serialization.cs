...
{
    internal partial class ResponseError : IJsonModel<ResponseError>
    {
        ...
        internal static ResponseError DeserializeResponseError(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        internal static ResponseError FromResponse(PipelineResponse response)
        {
