...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    internal partial class AgentList
    {
        ...
        internal AgentList(IEnumerable<AgentObject> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal AgentList(IReadOnlyList<AgentObject> data, AgentListObject @object, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Data = data;
            Object = @object;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="AgentList"/> for deserialization. </summary>
        internal AgentList()
        {
        }

        /// <summary> A list of items used to generate this response. </summary>
        public IReadOnlyList<AgentObject> Data { get; }
        /// <summary> The object type. Always 'list'. </summary>
        public AgentListObject Object { get; } = AgentListObject.List;
