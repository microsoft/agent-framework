...
namespace Microsoft.Agents.AI.Hosting.OpenAI.Responses.Generated.Models
{
    ...
    ///
    /// </summary>
    internal partial class MCPCallItemParam : ItemParam
    {
        ...
        internal MCPCallItemParam(ItemType type, IDictionary<string, BinaryData> serializedAdditionalRawData, string serverLabel, string name, string arguments, string output, string error) : base(type, serializedAdditionalRawData)
        {
            ServerLabel = serverLabel;
            Name = name;
            Arguments = arguments;
