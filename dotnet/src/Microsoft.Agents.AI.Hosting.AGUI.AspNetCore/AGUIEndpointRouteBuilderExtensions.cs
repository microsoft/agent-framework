...
public static class AGUIEndpointRouteBuilderExtensions
{
    ...
    /// <c>UseClaimsBasedStoreIsolation(...)</c> from
    /// <c>Microsoft.Agents.AI.Hosting.AspNetCore</c> (or by registering a custom
    /// <see cref="StoreIsolationKeyProvider"/>) and registering the store via the
        ...
        AIAgent aiAgent)
    {
        ...
        var isolationKeyProvider = endpoints.ServiceProvider.GetService<StoreIsolationKeyProvider>();
