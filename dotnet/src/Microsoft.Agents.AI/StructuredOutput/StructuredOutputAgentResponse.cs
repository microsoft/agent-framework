...
public class StructuredOutputAgentResponse : AgentResponse
{
    ...
    /// </summary>
    /// <param name="chatSoResponse">The <see cref="ChatResponse"/> containing the structured output.</param>
    /// <param name="agentResponse">The original <see cref="AgentResponse"/> from the inner agent.</param>
    internal StructuredOutputAgentResponse(ChatResponse chatSoResponse, AgentResponse agentResponse) : base(chatSoResponse)
    {
