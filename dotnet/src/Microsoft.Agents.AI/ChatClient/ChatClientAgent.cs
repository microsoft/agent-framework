...
public sealed partial class ChatClientAgent : AIAgent
{
    ...
    private static void ValidateStreamResumptionAllowed(ResponseContinuationToken? continuationToken, ChatClientAgentThread safeThread)
    {
        ...
        {
            throw new InvalidOperationException("Using non-agent service store for chat history with streaming resumption is not supported.");
        }
        ...
        {
            throw new InvalidOperationException("Using context provider with streaming resumption is not supported.");
        }
    }
