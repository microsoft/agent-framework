...
internal static partial class AgentJsonUtilities
{
    ...
    [JsonSerializable(typeof(MultiEditOperation))]
    [JsonSerializable(typeof(List<MultiEditOperation>))]
    [JsonSerializable(typeof(MultiEditResult))]
    [JsonSerializable(typeof(GlobResult))]
    [JsonSerializable(typeof(GrepResult))]
    [JsonSerializable(typeof(GrepResult.GrepHit))]
    [JsonSerializable(typeof(ListDirResult))]
    [JsonSerializable(typeof(ListDirResult.DirEntry))]
