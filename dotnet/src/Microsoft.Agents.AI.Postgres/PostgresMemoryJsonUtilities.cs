...
/// <summary>Provides a collection of utility methods for working with JSON data in the context of the PostgreSQL memory provider.</summary>
public static partial class PostgresMemoryJsonUtilities
{
    /// <summary>
    ...
    [JsonSerializable(typeof(PostgresMemoryContextProvider.State))]
