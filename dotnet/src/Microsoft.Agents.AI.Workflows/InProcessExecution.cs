...
public static class InProcessExecution
{
    ...
    public static ValueTask<StreamingRun> StreamAsync<TInput>(Workflow workflow, string? runId = null, CancellationToken cancellationToken = default) where TInput : notnull
    ...
    public static ValueTask<Checkpointed<StreamingRun>> StreamAsync<TInput>(Workflow workflow, CheckpointManager checkpointManager, string? runId = null, CancellationToken cancellationToken = default) where TInput : notnull
