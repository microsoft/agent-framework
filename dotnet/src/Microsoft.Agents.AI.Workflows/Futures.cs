...
public static class Futures
{
    ...
    /// </para>
    /// <para>
    /// <b>Interaction with the <see cref="WorkflowHostingExtensions.AsAIAgent(Workflow, string?, string?, string?, IWorkflowExecutionEnvironment?, bool, bool)"/>
    /// and <see cref="WorkflowHostingExtensions.AsAIAgent(Workflow, bool, string?, string?, string?, IWorkflowExecutionEnvironment?, bool, bool)"/> overloads.</b> When this flag
