...
internal static class DurableExecutorDispatcher
{
        ...
        ILogger logger)
    {
        ...
        PendingRequestPortStatus pendingEvent = new(EventName: eventName, Input: input);
        liveStatus.PendingEvents.Add(pendingEvent);
        ...
        liveStatus.PendingEvents.Remove(pendingEvent);
