...
public static class AIAgentExtensions
{
    ...
    public static void AttachA2AMessaging(this AIAgent agent, TaskManager taskManager, ILoggerFactory? loggerFactory = null)
    {
        taskManager ??= new();
        var a2aAgentWrapper = new A2AAgentWrapper(agent, taskManager, loggerFactory);
