...
public static class HostApplicationBuilderAgentExtensions
{
    ...
    public static IHostApplicationBuilder AddAIAgent(this IHostApplicationBuilder builder, string name, string? instructions)
    {
        ...
        builder.Services.AddAIAgent(name, instructions);
        return builder;
    }

    /// <summary>
    /// Adds an AI agent to the host application builder with the specified name, instructions, and chat client instance.
    /// </summary>
    /// <param name="builder">The host application builder to configure.</param>
    /// <param name="name">The name of the agent.</param>
    /// <param name="instructions">The instructions for the agent.</param>
    ...
    {
        Throw.IfNull(builder);
        builder.Services.AddAIAgent(name, instructions, chatClient);
        return builder;
    }

    /// <summary>
    /// Adds an AI agent to the host application builder with the specified name, instructions, description, and chat client service key.
    /// </summary>
    /// <param name="builder">The host application builder to configure.</param>
    /// <param name="name">The name of the agent.</param>
    /// <param name="instructions">The instructions for the agent.</param>
    ...
    {
        Throw.IfNull(builder);
        builder.Services.AddAIAgent(name, instructions, description, chatClientServiceKey);
        return builder;
    }

    /// <summary>
    /// Adds an AI agent to the host application builder with the specified name, instructions, and chat client service key.
    /// </summary>
    /// <param name="builder">The host application builder to configure.</param>
    /// <param name="name">The name of the agent.</param>
    /// <param name="instructions">The instructions for the agent.</param>
    ...
    {
        Throw.IfNull(builder);
        builder.Services.AddAIAgent(name, instructions, chatClientServiceKey);
        return builder;
    }
    ...
    {
        Throw.IfNull(builder);
        builder.Services.AddAIAgent(name, createAgentDelegate);
        return builder;
    }
}
