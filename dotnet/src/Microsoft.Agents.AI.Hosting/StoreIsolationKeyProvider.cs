...
/// <summary>
/// Provides an abstract base class for resolving isolation keys used to scope persisted agent data.
/// </summary>
/// <remarks>
/// <para>
/// Store isolation keys enable multi-tenant or multi-user scenarios by scoping persisted resources,
/// such as agent sessions and A2A tasks, to a specific logical partition (e.g., user ID, tenant ID,
/// or composite key). Derived classes implement the key resolution logic appropriate to their
/// hosting environment.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
public abstract class StoreIsolationKeyProvider
{
    /// <summary>
    /// Asynchronously retrieves the store isolation key for the current request or execution context.
    /// </summary>
    ...
    /// </remarks>
    public abstract ValueTask<string?> GetStoreIsolationKeyAsync(CancellationToken cancellationToken = default);
}
