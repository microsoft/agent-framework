...
public static class OpenAIResponseClientExtensions
{
    ...
    /// <param name="defaultModelId">Optional default model ID to use when communicating with the service.</param>
        ...
        IServiceProvider? services = null)
    {
        ...
        var chatClient = client.AsIChatClient(defaultModelId);
    ...
    public static IChatClient AsIChatClientWithStoredOutputDisabled(this ResponsesClient responseClient, string? defaultModelId = null, bool includeReasoningEncryptedContent = true)
    {
