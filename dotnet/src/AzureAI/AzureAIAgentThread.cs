...
public sealed class AzureAIAgentThread : AgentThread
{
    ...
    /// <inheritdoc />
    protected override async Task OnNewMessageInternalAsync(ChatMessage newMessage, CancellationToken cancellationToken = default)
    {
        ...
        if (newMessage.AdditionalProperties == null || !newMessage.AdditionalProperties.TryGetValue("ThreadId", out var messageThreadId) || !string.Equals(messageThreadId, this.Id))
        {
    ...
    public async IAsyncEnumerable<ChatMessage> GetMessagesAsync(ListSortOrder? sortOrder = default, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        if (this.IsDeleted)
        {
