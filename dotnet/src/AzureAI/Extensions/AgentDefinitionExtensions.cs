...
internal static class AgentDefinitionExtensions
{
    ...
    /// <param name="serviceProvider"><see cref="IServiceProvider"/> instance which will be used to resolve a default <see cref="PersistentAgentsClient"/>.</param>
    public static PersistentAgentsClient GetAgentsClient(this AgentDefinition agentDefinition, IServiceProvider serviceProvider)
    {
        Verify.NotNull(agentDefinition);
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        var client = serviceProvider.GetServices<PersistentAgentsClient>().FirstOrDefault();
