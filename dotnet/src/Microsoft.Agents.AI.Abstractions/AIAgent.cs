...
public abstract partial class AIAgent
{
    ...
    /// <summary>
    /// Gets a value indicating whether <see cref="Id"/> is an auto-generated identifier, that is, no
    /// explicit id was supplied by the caller or backing service (<see cref="IdCore"/> is <see langword="null"/>),
    /// so <see cref="Id"/> falls back to a value generated fresh per process.
    /// </summary>
    /// <remarks>
    /// Hosting uses this to detect, ahead of time, agents whose ids change on every process start.
    /// Such ids break crash-recovery resume of a workflow hosted as an agent, which matches its
    /// checkpoint to the rebuilt workflow by executor id.
    /// </remarks>
    internal bool HasAutoGeneratedId => this.IdCore is null;
