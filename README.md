...
> 📖 Looking for the framework overview, install matrix, and package docs? See [README-framework.md](README-framework.md). &nbsp;|&nbsp; 🇯🇵 日本語版は [hands-on.ja/README.md](hands-on.ja/README.md) を参照してください。
...
![HostedAgents_EVENTS](hands-on/HostedAgent_Events.png)
![HostedAgents_Tools](hands-on/HostedAgents_Tools.png)
---
